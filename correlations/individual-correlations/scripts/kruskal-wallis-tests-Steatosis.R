...
# Box plots
# ++++++++++++++++++++
# Plot GSH by Steatosis grade and color by grade
...
# Box plots
# ++++++++++++++++++++
# Plot GSSG by Steatosis grade and color by grade
p3 <- ggboxplot(data, x = "Steatosis", y = "GSSG", 
                color = "Steatosis", palette = "npg",
                order = c("0", "1", "2", "3", "4", "5"),
...
# Mean plots
# ++++++++++++++++++++
# Plot GSSG by Steatosis grade
# Add error bars: mean_se
# (other values include: mean_sd, mean_ci, median_iqr, ....)
p4 <- ggline(data, x = "Steatosis", y = "GSSG", 
             color = "Black",
             #color = "Steatosis", palette = "npg",
             add = c("mean_se", "jitter"), 
             order = c("0", "1", "2", "3", "4", "5"),
...
# Box plots
# ++++++++++++++++++++
# Plot Total GSH by Steatosis grade and color by grade
p5 <- ggboxplot(data, x = "Steatosis", y = "TotalGSH", 
                color = "Steatosis", palette = "npg",
                order = c("0", "1", "2", "3", "4", "5"),
...
# Mean plots
# ++++++++++++++++++++
# Plot Total GSH  by Steatosis grade
# Add error bars: mean_se
# (other values include: mean_sd, mean_ci, median_iqr, ....)
p6 <- ggline(data, x = "Steatosis", y = "TotalGSH", 
             color = "Black",
             #color = "Steatosis", palette = "npg",
             add = c("mean_se", "jitter"), 
             order = c("0", "1", "2", "3", "4", "5"),
...
# Box plots
# ++++++++++++++++++++
# Plot GSH/GSSG by Steatosis grade and color by grade
p5 <- ggboxplot(data, x = "Steatosis", y = "GSHGSSGRatio", 
                color = "Steatosis", palette = "npg",
                order = c("0", "1", "2", "3", "4", "5"),
...
# Mean plots
# ++++++++++++++++++++
# Plot GSH/GSSG  by Steatosis grade
# Add error bars: mean_se
# (other values include: mean_sd, mean_ci, median_iqr, ....)
p6 <- ggline(data, x = "Steatosis", y = "GSHGSSGRatio", 
             color = "Black",
             #color = "Steatosis", palette = "npg",
             add = c("mean_se", "jitter"), 
             order = c("0", "1", "2", "3", "4", "5"),
...
# Box plots
# ++++++++++++++++++++
# Plot Eh GSSG/2GSH by Steatosis grade and color by grade
p7 <- ggboxplot(data, x = "Steatosis", y = "EhGSSG2GSH", 
                color = "Steatosis", palette = "npg",
                order = c("0", "1", "2", "3", "4", "5"),
...
# Mean plots
# ++++++++++++++++++++
# Plot Eh GSSG/2GSH  by Steatosis grade
# Add error bars: mean_se
# (other values include: mean_sd, mean_ci, median_iqr, ....)
p8 <- ggline(data, x = "Steatosis", y = "EhGSSG2GSH", 
             color = "Black",
             #color = "Steatosis", palette = "npg",
             add = c("mean_se", "jitter"), 
             order = c("0", "1", "2", "3", "4", "5"),
...
# Box plots
# ++++++++++++++++++++
# Plot NADH by Steatosis grade and color by grade
p9 <- ggboxplot(data, x = "Steatosis", y = "NADH", 
                color = "Steatosis", palette = "npg",
                order = c("0", "1", "2", "3", "4", "5"),
...
# Mean plots
# ++++++++++++++++++++
# Plot NADH by Steatosis grade
# Add error bars: mean_se
# (other values include: mean_sd, mean_ci, median_iqr, ....)
p10 <- ggline(data, x = "Steatosis", y = "NADH", 
             color = "Black",
             #color = "Steatosis", palette = "npg",
             add = c("mean_se", "jitter"), 
             order = c("0", "1", "2", "3", "4", "5"),
...
# Box plots
# ++++++++++++++++++++
# Plot NADP by Steatosis grade and color by grade
p11 <- ggboxplot(data, x = "Steatosis", y = "NADP", 
                color = "Steatosis", palette = "npg",
                order = c("0", "1", "2", "3", "4", "5"),
...
# Mean plots
# ++++++++++++++++++++
# Plot NADP by Steatosis grade
# Add error bars: mean_se
# (other values include: mean_sd, mean_ci, median_iqr, ....)
p12 <- ggline(data, x = "Steatosis", y = "NADP", 
              color = "Black",
              #color = "Steatosis", palette = "npg",
              add = c("mean_se", "jitter"), 
              order = c("0", "1", "2", "3", "4", "5"),
...
# Box plots
# ++++++++++++++++++++
# Plot NADPH by Steatosis grade and color by grade
p13 <- ggboxplot(data, x = "Steatosis", y = "NADPH", 
                color = "Steatosis", palette = "npg",
                order = c("0", "1", "2", "3", "4", "5"),
...
# Mean plots
# ++++++++++++++++++++
# Plot NADPH by Steatosis grade
# Add error bars: mean_se
# (other values include: mean_sd, mean_ci, median_iqr, ....)
p14 <- ggline(data, x = "Steatosis", y = "NADPH", 
              color = "Black",
              #color = "Steatosis", palette = "npg",
              add = c("mean_se", "jitter"), 
              order = c("0", "1", "2", "3", "4", "5"),
...
# Box plots
# ++++++++++++++++++++
# Plot NADP/NADPH by Steatosis grade and color by grade
p15 <- ggboxplot(data, x = "Steatosis", y = "NADPNADPHRatio", 
                 color = "Steatosis", palette = "npg",
                 order = c("0", "1", "2", "3", "4", "5"),
...
# Mean plots
# ++++++++++++++++++++
# Plot NADP/NADPH by Steatosis grade
# Add error bars: mean_se
# (other values include: mean_sd, mean_ci, median_iqr, ....)
p16 <- ggline(data, x = "Steatosis", y = "NADPNADPHRatio", 
              color = "Black",
              #color = "Steatosis", palette = "npg",
              add = c("mean_se", "jitter"), 
              order = c("0", "1", "2", "3", "4", "5"),
...
# Box plots
# ++++++++++++++++++++
# Plot AST by Steatosis grade and color by grade
p17 <- ggboxplot(data, x = "Steatosis", y = "AST", 
                 color = "Steatosis", palette = "npg",
                 order = c("0", "1", "2", "3", "4", "5"),
...
# Mean plots
# ++++++++++++++++++++
# Plot AST by Steatosis grade
# Add error bars: mean_se
# (other values include: mean_sd, mean_ci, median_iqr, ....)
p18 <- ggline(data, x = "Steatosis", y = "AST", 
              color = "Black",
              #color = "Steatosis", palette = "npg",
              add = c("mean_se", "jitter"), 
              order = c("0", "1", "2", "3", "4", "5"),
...
# Box plots
# ++++++++++++++++++++
# Plot ALT by Steatosis grade and color by grade
p19 <- ggboxplot(data, x = "Steatosis", y = "ALT", 
                 color = "Steatosis", palette = "npg",
                 order = c("0", "1", "2", "3", "4", "5"),
...
# Mean plots
# ++++++++++++++++++++
# Plot ALT by Steatosis grade
# Add error bars: mean_se
# (other values include: mean_sd, mean_ci, median_iqr, ....)
p20 <- ggline(data, x = "Steatosis", y = "ALT", 
              color = "Black",
              #color = "Steatosis", palette = "npg",
              add = c("mean_se", "jitter"), 
              order = c("0", "1", "2", "3", "4", "5"),
...
# Box plots
# ++++++++++++++++++++
# Plot BUN by Steatosis grade and color by grade
p21 <- ggboxplot(data, x = "Steatosis", y = "BUN", 
                 color = "Steatosis", palette = "npg",
                 order = c("0", "1", "2", "3", "4", "5"),
...
# Mean plots
# ++++++++++++++++++++
# Plot BUN by Steatosis grade
# Add error bars: mean_se
# (other values include: mean_sd, mean_ci, median_iqr, ....)
p22 <- ggline(data, x = "Steatosis", y = "BUN", 
              color = "Black",
              #color = "Steatosis", palette = "npg",
              add = c("mean_se", "jitter"), 
              order = c("0", "1", "2", "3", "4", "5"),
...
# Box plots
# ++++++++++++++++++++
# Plot Glucose by Steatosis grade and color by grade
p23 <- ggboxplot(data, x = "Steatosis", y = "Glucose", 
                 color = "Steatosis", palette = "npg",
                 order = c("0", "1", "2", "3", "4", "5"),
...
# Mean plots
# ++++++++++++++++++++
# Plot Glucose by Steatosis grade
# Add error bars: mean_se
# (other values include: mean_sd, mean_ci, median_iqr, ....)
p24 <- ggline(data, x = "Steatosis", y = "Glucose", 
              color = "Black",
              #color = "Steatosis", palette = "npg",
              add = c("mean_se", "jitter"), 
              order = c("0", "1", "2", "3", "4", "5"),
...
# Box plots
# ++++++++++++++++++++
# Plot Liver Weight by Steatosis grade and color by grade
p25 <- ggboxplot(data, x = "Steatosis", y = "LiverWeight", 
                 color = "Steatosis", palette = "npg",
                 order = c("0", "1", "2", "3", "4", "5"),
...
# Mean plots
# ++++++++++++++++++++
# Plot Liver Weight by Steatosis grade
# Add error bars: mean_se
# (other values include: mean_sd, mean_ci, median_iqr, ....)
p26 <- ggline(data, x = "Steatosis", y = "LiverWeight", 
              color = "Black",
              #color = "Steatosis", palette = "npg",
              add = c("mean_se", "jitter"), 
              order = c("0", "1", "2", "3", "4", "5"),
...
# Box plots
# ++++++++++++++++++++
# Plot Ballooning by Steatosis grade and color by grade
p27 <- ggboxplot(data, x = "Steatosis", y = "Ballooning", 
                 color = "Steatosis", palette = "npg",
                 order = c("0", "1", "2", "3", "4", "5"),
                 ylab = "Ballooning", xlab = "Steatosis Grade")

# Mean plots
# ++++++++++++++++++++
# Plot Ballooning by Steatosis grade
# Add error bars: mean_se
# (other values include: mean_sd, mean_ci, median_iqr, ....)
p28 <- ggline(data, x = "Steatosis", y = "Ballooning", 
              color = "Black",
              #color = "Steatosis", palette = "npg",
              add = c("mean_se", "jitter"), 
              order = c("0", "1", "2", "3", "4", "5"),
