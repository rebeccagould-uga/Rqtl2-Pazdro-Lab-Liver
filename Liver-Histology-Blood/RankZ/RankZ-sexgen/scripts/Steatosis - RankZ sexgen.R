...
#set working directory
pdf(file = "Steatosis-NAFLD-Genes-RankZ-sexgen.pdf")
##NOW SAVING ALL PLOTS AND TABLES ONTO A PDF##

#Pnpla3 - chr 15 39.78 cM
chr = 15
#coef_blup_Steatosis_chr15 <- scan1blup(genoprobs =  probs[,chr], pheno = pheno["zSteatosis"], kinship = kinship_loco[[chr]], addcovar = sexgen, cores = 2)
plot_coefCC(x = coef_blup_Steatosis_chr15, map = R01_GSH_DO_QTLdata$gmap, scan1_output = qtlscan_Steatosis, main = "Steatosis BLUPs plotted with CC Founders", legend = "bottomleft", bgcolor="gray95")
xlim <- c(38.5,41.5)
plot_coefCC(x = coef_blup_Steatosis_chr15, map = R01_GSH_DO_QTLdata$gmap, scan1_output = qtlscan_Steatosis, main = "Pnpla3 Position -- Steatosis BLUPs plotted with CC Founders", legend = "bottomleft", bgcolor="gray95", xlim = xlim)

#Tm6sf2 - chr 8 34.15 cM
chr = 8
#coef_blup_Steatosis_chr8 <- scan1blup(genoprobs =  probs[,chr], pheno = pheno["zSteatosis"], kinship = kinship_loco[[chr]], addcovar = sexgen, cores = 2)
plot_coefCC(x = coef_blup_Steatosis_chr8, map = R01_GSH_DO_QTLdata$gmap, scan1_output = qtlscan_Steatosis, main = "Steatosis BLUPs plotted with CC Founders", legend = "bottomleft", bgcolor="gray95")
xlim <- c(32.5,35.5)
plot_coefCC(x = coef_blup_Steatosis_chr8, map = R01_GSH_DO_QTLdata$gmap, scan1_output = qtlscan_Steatosis, main = "Tm6sf2 and Ncan Position -- Steatosis BLUPs plotted with CC Founders", legend = "bottomleft", bgcolor="gray95", xlim = xlim)

#Mboat7 - chr 7 2.12 cM
chr = 7
#coef_blup_Steatosis_chr7 <- scan1blup(genoprobs =  probs[,chr], pheno = pheno["zSteatosis"], kinship = kinship_loco[[chr]], addcovar = sexgen, cores = 2)
plot_coefCC(x = coef_blup_Steatosis_chr7, map = R01_GSH_DO_QTLdata$gmap, scan1_output = qtlscan_Steatosis, main = "Steatosis BLUPs plotted with CC Founders", legend = "bottomleft", bgcolor="gray95")
xlim <- c(1.8,3.5)
plot_coefCC(x = coef_blup_Steatosis_chr7, map = R01_GSH_DO_QTLdata$gmap, scan1_output = qtlscan_Steatosis, main = "Mboat7 Position -- Steatosis BLUPs plotted with CC Founders", legend = "bottomleft", bgcolor="gray95", xlim = xlim)

#Gckr - chr 5 17.27 cM
chr = 5
#coef_blup_Steatosis_chr5 <- scan1blup(genoprobs =  probs[,chr], pheno = pheno["zSteatosis"], kinship = kinship_loco[[chr]], addcovar = sexgen, cores = 2)
plot_coefCC(x = coef_blup_Steatosis_chr5, map = R01_GSH_DO_QTLdata$gmap, scan1_output = qtlscan_Steatosis, main = "Steatosis BLUPs plotted with CC Founders", legend = "bottomleft", bgcolor="gray95")
xlim <- c(15,18.5)
plot_coefCC(x = coef_blup_Steatosis_chr5, map = R01_GSH_DO_QTLdata$gmap, scan1_output = qtlscan_Steatosis, main = "Gckr Position -- Steatosis BLUPs plotted with CC Founders", legend = "bottomleft", bgcolor="gray95", xlim = xlim)
...
plot_coefCC(x = coef_blup_Steatosis_chr5, map = R01_GSH_DO_QTLdata$gmap, scan1_output = qtlscan_Steatosis, main = "Steatosis BLUPs plotted with CC Founders", legend = "bottomleft", bgcolor="gray95")
xlim <- c(48.5, 51.5)
plot_coefCC(x = coef_blup_Steatosis_chr5, map = R01_GSH_DO_QTLdata$gmap, scan1_output = qtlscan_Steatosis, main = "Hsd17b13 Position -- Steatosis BLUPs plotted with CC Founders", legend = "bottomleft", bgcolor="gray95", xlim = xlim)
...
#plot_coefCC(x = coef_blup_Steatosis_chr8, map = R01_GSH_DO_QTLdata$gmap, scan1_output = qtlscan_Steatosis, main = "Steatosis BLUPs plotted with CC Founders", legend = "bottomleft", bgcolor="gray95")
#xlim <- c(48.5, 51.5)
#plot_coefCC(x = coef_blup_Steatosis_chr8, map = R01_GSH_DO_QTLdata$gmap, scan1_output = qtlscan_Steatosis, main = "Pnpla3 Position -- Steatosis BLUPs plotted with CC Founders", legend = "bottomleft", bgcolor="gray95", xlim = xlim)

#Lyplal1 - chr 1 89.81 cM
chr = 1
#coef_blup_Steatosis_chr1 <- scan1blup(genoprobs =  probs[,chr], pheno = pheno["zSteatosis"], kinship = kinship_loco[[chr]], addcovar = sexgen, cores = 2)
plot_coefCC(x = coef_blup_Steatosis_chr1, map = R01_GSH_DO_QTLdata$gmap, scan1_output = qtlscan_Steatosis, main = "Steatosis BLUPs plotted with CC Founders", legend = "bottomleft", bgcolor="gray95")
xlim <- c(48.5, 51.5)
plot_coefCC(x = coef_blup_Steatosis_chr1, map = R01_GSH_DO_QTLdata$gmap, scan1_output = qtlscan_Steatosis, main = "Lyplal1 Position -- Steatosis BLUPs plotted with CC Founders", legend = "bottomleft", bgcolor="gray95", xlim = xlim)
...
plot_coefCC(x = coef_blup_Steatosis_chr8, map = R01_GSH_DO_QTLdata$gmap, scan1_output = qtlscan_Steatosis, main = "Steatosis BLUPs plotted with CC Founders", legend = "bottomleft", bgcolor="gray95")
xlim <- c(19.5, 23.5)
plot_coefCC(x = coef_blup_Steatosis_chr8, map = R01_GSH_DO_QTLdata$gmap, scan1_output = qtlscan_Steatosis, main = "Ppp1r3b Position -- Steatosis BLUPs plotted with CC Founders", legend = "bottomleft", bgcolor="gray95", xlim = xlim)
