...
GSSGcovar = model.matrix (~ sex + generation + zLiverGSSG, data = pheno)[,-1]
...
pdf(file = "GSH GSSG Covar QTL Results - RankZ sexgen.pdf")
##NOW SAVING ALL PLOTS AND TABLES ONTO A PDF##
  ...
  write_xlsx(list("GSH GSSG Covar gmap (cM)" = gmap_peaksGSH_GSSGCovar,
             ...
             "GSH GSSG Covar Peaks - RankZ sexgen.xlsx")
