...
qtlscan_LiverGSH_GSSGRatio<- scan1(genoprobs = probs, pheno = pheno["logLiverGSH_GSSGRatio"], kinship = kinship_loco, addcovar = sexgen, cores=10)
perm_LiverGSH_GSSGRatio <- scan1perm(genoprobs = probs, pheno = pheno["logLiverGSH_GSSGRatio"], addcovar = sexgen, n_perm = 1000, cores=10)

par(mar=c(4.1, 4.1, 2.6, 2.6))
threshold_LiverGSH_GSSGRatio = summary(perm_LiverGSH_GSSGRatio, alpha = c(0.35, 0.2, 0.1, 0.05))
...
abline(h = threshold_LiverGSH_GSSGRatio, col = c("orange","purple", "red", "blue"), lwd = 2)
#using gmap (cM)
...
#using gmap (cM)
  chr = 16
  coef_blup_LiverGSH_GSSGRatio_chr16 <- scan1blup(genoprobs =  probs[,chr], pheno = pheno["logLiverGSH_GSSGRatio"], kinship = kinship_loco[[chr]], addcovar = sexgen, cores = 10)
...
#using pmap (Mbp)
  ...
  variants_LiverGSH_GSSGRatio_chr16 <- query_variants(chr, start - 1, end + 1)
  out_snps_LiverGSH_GSSGRatio_chr16 <- scan1snps(genoprobs = probs, map = R01_GSH_DO_QTLdata$pmap, pheno = pheno["logLiverGSH_GSSGRatio"], kinship = kinship_loco[[chr]], addcovar = sexgen, query_func = query_variants,
  ...
  LiverGSH_GSSGRatio_Genes_MGI_chr16 <- query_genes_mgi(chr = chr, start = start-1, end = end+1)
...
#For Liver GSH/GSSG --- Chromosome 11
  ...
  #using gmap (cM)
  chr = 11
  coef_blup_LiverGSH_GSSGRatio_chr11 <- scan1blup(genoprobs =  probs[,chr], pheno = pheno["logLiverGSH_GSSGRatio"], kinship = kinship_loco[[chr]], addcovar = sexgen, cores = 10)
  ...
  out_snps_LiverGSH_GSSGRatio_chr11 <- scan1snps(genoprobs = probs, map = R01_GSH_DO_QTLdata$pmap, pheno = pheno["logLiverGSH_GSSGRatio"], kinship = kinship_loco[[chr]], addcovar = sexgen, query_func = query_variants,
                                                 chr = chr, start = start-1, end = end+1, keep_all_snps = TRUE)
...
out_gwas_LiverGSH_GSSGRatio <- scan1snps(genoprobs = probs, map = R01_GSH_DO_QTLdata$pmap, pheno = pheno["logLiverGSH_GSSGRatio"], kinship = kinship_loco, addcovar = sexgen, query_func=query_variants, cores=10)
par(mar=c(4.1, 4.1, 2.6, 2.6))
