...
#For Kidney GSH/GSSG --- Chromosome 16
  ...
  #using gmap (cM)
  chr = 16
  coef_blup_KidneyGSH_GSSGRatio_chr16 <- scan1blup(genoprobs =  probs[,chr], pheno = pheno["zKidneyGSH_GSSGRatio"], kinship = kinship_loco[[chr]], addcovar = sex, cores = 10)
  ...
  out_snps_KidneyGSH_GSSGRatio_chr16 <- scan1snps(genoprobs = probs, map = R01_GSH_DO_QTLdata$pmap, pheno = pheno["zKidneyGSH_GSSGRatio"], kinship = kinship_loco[[chr]], addcovar = sex, query_func = query_variants,
