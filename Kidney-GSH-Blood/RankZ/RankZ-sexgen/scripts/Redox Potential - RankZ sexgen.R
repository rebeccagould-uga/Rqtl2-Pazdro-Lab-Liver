...
qtlscan_KidneyRedoxPotentialGSSG2GSH<- scan1(genoprobs = probs, pheno = pheno["zKidneyRedoxPotentialGSSG2GSH"], kinship = kinship_loco, addcovar = sexgen, cores=10)
...
herit_KidneyRedoxPotentialGSSG2GSH_sex <- est_herit(pheno["zKidneyRedoxPotentialGSSG2GSH"], kinship_lmm, sex, cores = 10)
herit_KidneyRedoxPotentialGSSG2GSH_sexgen <- est_herit(pheno["zKidneyRedoxPotentialGSSG2GSH"], kinship_lmm, sexgen, cores = 10)
