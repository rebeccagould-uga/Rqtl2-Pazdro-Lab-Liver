...
#For Kidney NADH
  boxplot(pheno$Kidney_NADH, main = "Kidney NADH Box Plot")
  boxplot(pheno$Kidney_NADH~pheno$generation, main = "Kidney NADH Box Plot - by generation")
  boxplot(pheno$zKidneyNADH, main = "Rank Z Kidney NADH Box Plot")
  boxplot(pheno$zKidneyNADH~pheno$generation, main = "Rank Z Kidney NADH Box Plot - by generation")
  #check if it is normally distributed
  qqnorm(pheno$zKidneyNADH, main = "Normal QQ Plot - Rank Z Kidney NADH")
  
#For Kidney NADP
  boxplot(pheno$Kidney_NADP, main = "Kidney NADP Box Plot")
  boxplot(pheno$Kidney_NADP~pheno$generation, main = "Kidney NADP Box Plot - by generation")
  boxplot(pheno$zKidneyNADP, main = "Rank Z Kidney NADP Box Plot")
  boxplot(pheno$zKidneyNADP~pheno$generation, main = "Rank Z Kidney NADP Box Plot - by generation")
  #check if it is normally distributed
  qqnorm(pheno$zKidneyNADP, main = "Normal QQ Plot - Rank Z Kidney NADP")
  
#For Kidney NADPH
  boxplot(pheno$Kidney_NADPH, main = "Kidney NADPH Box Plot")
  boxplot(pheno$Kidney_NADPH~pheno$generation, main = "Kidney NADPH Box Plot - by generation")
  boxplot(pheno$zKidneyNADPH, main = "Rank Z Kidney NADPH Box Plot")
  boxplot(pheno$zKidneyNADPH~pheno$generation, main = "Rank Z Kidney NADPH Box Plot - by generation")
  #check if it is normally distributed
  qqnorm(pheno$zKidneyNADPH, main = "Normal QQ Plot - Rank Z Kidney NADPH")
  
#For Kidney NADP/NADPH Ratio
  boxplot(pheno$Kidney_NADP_NADPH_Ratio, main = "Kidney NADP/NADPH Box Plot")
  boxplot(pheno$Kidney_NADP_NADPH_Ratio~pheno$generation, main = "Kidney NADP/NADPH Box Plot - by generation")
  boxplot(pheno$zKidneyNADP_NADPHRatio, main = "Rank Z Kidney NADP/NADPH Box Plot")
  boxplot(pheno$zKidneyNADP_NADPHRatio~pheno$generation, main = "Rank Z Kidney NADP/NADPH Box Plot - by generation")
  #check if it is normally distributed
  qqnorm(pheno$zKidneyNADP_NADPH, main = "Normal QQ Plot - Rank Z Kidney NADP/NADPH")
